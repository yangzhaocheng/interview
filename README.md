- [数据结构](#----)
  ...
  * [查找](#--)
    + [顺序查找](#----)
    + [二分查找 o(nlog(n))](#-----o-nlog-n--)
    + [分块查找](#----)
    + [B树和B+树查找](#b--b----)
    + [hash表查找 o(1)](#hash----o-1-)
  * [排序](#--)
    + [插入排序](#----)
      - [直接插入排序](#------)
      - [折半插入排序](#------)
...
- [算法题常见套路](#-------)
  ...
  * [动态规划](#----)
    + [定义：动态规划一般应用于组合优化问题，这种问题一般由一个对应的目标函数和约束条件，能有效 **利用前面已经得到的结果** ，最大限度减少重复工作，以提高算法效率，但是一般往往消耗更多储存](#---------------------------------------------------------------------------------------------)
      - [[编辑距离](https://leetcode-cn.com/problems/edit-distance/solution/bian-ji-ju-chi-mian-shi-ti-xiang-jie-by-labuladong/) *重点*](#-------https---leetcode-cncom-problems-edit-distance-solution-bian-ji-ju-chi-mian-shi-ti-xiang-jie-by-labuladong-------)
  * [双指针](#---)
      - [[合并两个有序数组](https://leetcode-cn.com/problems/merge-sorted-array/solution/he-bing-liang-ge-you-xu-shu-zu-by-leetcode/)](#-----------https---leetcode-cncom-problems-merge-sorted-array-solution-he-bing-liang-ge-you-xu-shu-zu-by-leetcode--)
  * [操作系统和redis相关使用的算法](#-----redis-------)
- [智力题](#---)
- [计算机基础](#-----)
  * [操作系统](#----)
  * [计算机网络](#-----)
...
- [mysql相关](#mysql--)
- [spring 相关](#spring---)
  * [spring mysql操作](#spring-mysql--)
  * [spring aop](#spring-aop)
  * [spring ioc](#spring-ioc)
  * [spring 中的设计模式](#spring-------)
- [netty参数](#netty--)
- [kafka 相关](#kafka---)
- [公司面试](#----)
  * [[头条(校招)：](https://mp.weixin.qq.com/s/REBPmDPLqxmzTUXU6Cmg7A)](#----------https---mpweixinqqcom-s-rebpmdplqxmztuxu6cmg7a-)
    + [字节跳动技术一面](#--------)
    + [字节跳动技术二面](#--------)
    + [字节跳动技术三面](#--------)
    + [字节跳动技术四面](#--------)
  * [[快手(社招)：](https://yq.aliyun.com/articles/682816)](#----------https---yqaliyuncom-articles-682816-)
    + [**一面(一个小时十分钟)**](#---------------)
    + [二面(四十多分钟)](#---------)
    + [三面(50分钟：主要分布式这块)](#---50-----------)
- [项目相关：](#-----)
